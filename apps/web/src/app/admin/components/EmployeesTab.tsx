...
const PERMISSION_OPTIONS = ["manage_tutors", "manage_students"];
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="manage_tutors, manage_students"
                />
                <p
              ...
              {subadminsQuery.isLoading ? (
                ...
                <tr>
                  <td
                    ...
                    style={{ color: "var(--text-muted)" }}
                  >
                    {lang === "ar" ? "لا يوجد مشرفون فرعيون" : "No sub-admins"}
                  </td>
                </tr>
              ) : (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      {s.isActive ? (
                        ...
                        >
                          {lang === "ar" ? "في انتظار القبول" : "Pending"}
                        </span>
                      ) : (
                        <span
                          className="badge text-xs"
