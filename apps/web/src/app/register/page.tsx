...
export default function RegisterPage() {
  ...
  return (
    <main
      className="relative flex min-h-screen items-center justify-center overflow-hidden px-3 py-6 sm:p-6"
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    isAr ? "15 حرفاً على الأقل" : "At least 15 characters"
                  }
                  className="input-field"
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="new-password"
                  placeholder={
                    isAr ? "أعد كتابة كلمة المرور" : "Repeat your password"
                  }
                  className="input-field"
            ...
            >
              <p className="font-semibold">
                {isAr ? "إنشاء حساب طالب" : "Create a student account"}
              </p>
              <p className="mt-1" style={{ color: "var(--text-muted)" }}>
                {isAr
                  ? "هل تريد التدريس في Mr.H Academy؟ أنشئ حساب طالب أولاً، ثم قدم طلب التسجيل كمدرس لمراجعته من قبل الإدارة."
                  : "Want to teach at Mr.H Academy? Create your account first, then submit a tutor application for review."}
              </p>
              <Link
                href="/become-teacher"
