...
export default function SettingsView() {
  ...
  const updateProfileMutation = useMutation({
    ...
    onSuccess: () =>
      showSuccess(t("تم تحديث الملف الشخصي", "Profile updated successfully")),
  });
  ...
  const changeEmailMutation = useMutation({
    ...
    onSuccess: () => {
      showSuccess(
        t("تم تغيير البريد الإلكتروني", "Email changed successfully"),
      );
  ...
  const renderSection = () => {
    switch (activeSection) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="input-field text-sm"
                >
                  <option value={profileForm.timezone}>
          ...
          <div className="card p-6 space-y-4">
            ...
            <div>
              <label
                ...
                style={{ color: "var(--text-main)" }}
              >
                {t("كلمة المرور للتأكيد", "Password to confirm")}
              </label>
              <input
                type="password"
          ...
          <div className="card p-6 space-y-4">
            ...
            {paymentMethods.length === 0 ? (
              <div className="py-8 text-center">
                <p className="text-sm" style={{ color: "var(--text-muted)" }}>
                  {t("لا توجد طرق دفع مضافة", "No payment methods added yet")}
                </p>
              </div>
            ) : (
      ...
      case "notifications":
        return <NotificationPreferencesPanel lang={lang} t={t} />;
        ...
        return (
          ...
          >
            ...
            >
              ...
              >
                {t(
                  "حذف حسابك سيؤدي إلى إزالة جميع بياناتك بشكل دائم. لا يمكن التراجع عن هذا الإجراء.",
            ...
            <button
              ...
              disabled={
                deleteConfirm !== (lang === "ar" ? "حذف" : "delete") ||
  ...
  return (
    <div className="flex gap-6">
      <nav className="w-56 shrink-0">
        <div
          className="card p-2 sticky top-24"
