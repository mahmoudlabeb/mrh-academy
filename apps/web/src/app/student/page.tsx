...
function StudentDashboardContent() {
      ...
      case 'discover':
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 stagger-children">
            <Link href="/student/discover" className="card-gold p-8 group animate-slide-up">
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-all group-hover:scale-110" style={{ background: 'rgba(212, 163, 83,0.15)' }}>
            ...
            <Link href="/student/discover?sort=asc" className="card-gold p-8 group animate-slide-up" style={{ animationDelay: '0.1s' }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-all group-hover:scale-110" style={{ background: 'rgba(212, 163, 83,0.15)' }}>
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="#D4A353">
            ...
            <Link href="/student/discover?sort=desc" className="card-gold p-8 group animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-all group-hover:scale-110" style={{ background: 'rgba(212, 163, 83,0.15)' }}>
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="#D4A353">
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-main)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-1 md:gap-1.5">
              ...
              <button onClick={toggleLanguage} className="px-2.5 py-1.5 rounded-lg text-sm font-semibold transition-colors hover:bg-white/5 text-[#FFFFF0]">
                {lang === 'ar' ? 'EN' : 'AR'}
              </button>
              ...
              <div className="relative">
                <button onClick={() => setShowProfileMenu(!showProfileMenu)} className="flex items-center gap-2 p-1 pr-2 rounded-lg hover:bg-white/5 transition-colors">
                  ...
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="#E4CC9C">
                ...
                {showProfileMenu && (
                  <>
                    ...
                    <div className="absolute top-full left-0 mt-2 w-52 rounded-xl py-2 shadow-xl z-20 animate-scale-in" style={{ background: 'var(--bg-light)', border: '1px solid var(--border-color)' }}>
                      <div className="px-4 py-3 border-b" style={{ borderColor: 'var(--border-color)' }}>
                        <p className="text-sm font-bold" style={{ color: 'var(--text-main)' }}>{user?.firstName} {user?.lastName}</p>
      ...
      <nav className="sticky top-0 z-10 backdrop-blur-xl" style={{ background: 'var(--bg-light)', borderBottom: '1px solid var(--border-color)' }}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex gap-1">
            {tabs.map((tab) => (
              ...
              >
                ...
                {activeTab === tab.key && (
                  <span className="absolute bottom-0 left-0 right-0 h-0.5 rounded-full" style={{ background: '#D4A353' }} />
                )}
              </button>
            ))}
          </div>
