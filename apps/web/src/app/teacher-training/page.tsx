      ...
      >
        <div className="text-center">
          ...
          <p style={{ color: "var(--text-muted)" }}>
            {t("جاري تحميل المقالات...", "Loading articles...")}
          </p>
        </div>
      </div>
    );
        ...
        {selected ? (
          <article className="card p-8 animate-scale-in">
            <button
              ...
              className="link inline-flex items-center gap-1 mb-6"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            {articles.length === 0 ? (
              <div className="card p-12 text-center">
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  {t("لم يتم نشر مقالات بعد", "No articles published yet")}
                </p>
                <p
                ...
                >
                  {t(
                    "تحقق مرة أخرى قريبًا للحصول على موارد تدريبية جديدة",
