...
export default function MessagesView({
  ...
  return (
    <div
      className="flex h-[calc(100vh-140px)] rounded-xl overflow-hidden"
      style={{
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  {contact.lastMessage?.content ??
                    t("بدون رسائل", "No messages")}
                </p>
              </div>
              {contact.unreadCount > 0 && (
                <span
                  className="badge flex-shrink-0 text-xs font-bold px-2 py-0.5"
                  style={{
                      ...
                      <div
                        ...
                        style={{
                          background: isMe
                            ? "var(--primary-color)"
                            : "var(--bg-light)",
                          color: isMe ? "var(--ink)" : "var(--text-main)",
                        }}
                      >
                        <p>{msg.content}</p>
