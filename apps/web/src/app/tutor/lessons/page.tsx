    ...
    onError: (e: { response?: { data?: { message?: string } } }) => {
      setError(
        e.response?.data?.message ??
          t("فشل قبول الدرس", "Failed to approve lesson"),
      );
    },
  });
        ...
        {[
          {
            ...
            label: `${t("طلبات جديدة", "New Requests")} (${pendingLessons.length})`,
          },
          {
            ...
            >
              ...
              {lesson.status === "pending" && (
                <div className="flex gap-2 shrink-0">
                  <button
                    onClick={() => approveMutation.mutate(lesson.id)}
                  ...
                  <button
                    onClick={() => rejectMutation.mutate(lesson.id)}
