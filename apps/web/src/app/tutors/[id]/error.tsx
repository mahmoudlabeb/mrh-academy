  ...
  return (
    ...
    >
      <div className="card max-w-md w-full p-8 text-center animate-fade-in">
        ...
        >
          {t("تعذر تحميل الملف الشخصي", "Could not load this profile")}
        </h1>
        <p className="mb-6" style={{ color: "var(--text-muted)" }}>
          {t(
            "حدث خطأ أثناء محاولة تحميل بيانات المعلم. يرجى المحاولة مرة أخرى.",
            "Something went wrong while loading the tutor. Please try again.",
          )}
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/student/discover" className="btn-secondary px-6 py-3">
