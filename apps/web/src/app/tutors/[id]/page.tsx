      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        <div className="card p-8 animate-scale-in">
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-4 p-3 rounded-xl" style={{ background: 'var(--bg-light)', border: '1px solid var(--border-color)' }}>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-sm font-semibold" style={{ color: 'var(--text-main)' }}>
                        {tutor.averageRating ? tutor.averageRating.toFixed(1) : 'جديد'}
                      </span>
          ...
          <div className="mt-6 pt-6 grid grid-cols-1 sm:grid-cols-2 gap-3" style={{ borderTop: '1px solid var(--border-color)' }}>
            ...
            <button className="flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-semibold rounded-xl transition-all" style={{ border: '1px solid var(--border-color)', color: 'var(--text-main)', background: 'var(--bg-light)' }}>
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
