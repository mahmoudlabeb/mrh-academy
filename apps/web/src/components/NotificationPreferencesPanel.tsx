...
const ITEMS: Item[] = [
  ...
  {
    key: "browser",
    labelAr: "إشعارات المتصفح",
    labelEn: "Browser Notifications",
  },
  { key: "sms", labelAr: "إشعارات SMS", labelEn: "SMS Notifications" },
  {
    key: "lesson_reminders",
    labelAr: "تذكير بالدروس",
    labelEn: "Lesson Reminders",
  },
  ...
  {
    key: "payment_updates",
    labelAr: "تحديثات الدفع",
    labelEn: "Payment Updates",
  },
];
...
export default function NotificationPreferencesPanel({
  ...
  const { data: prefs, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await apiClient.get<Prefs>(
          ...
          return (
            ...
            >
              ...
              <button
                ...
                style={{
                  background: on ? "var(--signal)" : "var(--border-color)",
                }}
              >
                <div
